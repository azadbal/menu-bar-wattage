...
printf '\n[2/4] Running MenuBarWattageApp tests...\n'
swift test --package-path "$ROOT_DIR/MenuBarWattageApp"
...
if command -v swift-format >/dev/null 2>&1; then
  swift-format lint -r "$ROOT_DIR/Packages/PowerCore/Sources" "$ROOT_DIR/MenuBarWattageApp/Sources"
else
